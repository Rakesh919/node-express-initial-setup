...
const errorTransport = new transports.DailyRotateFile({filename: 'error-%DATE%.log', level:'error', maxSize: '10m',
maxFiles: '7d', datePattern: 'YYYY-MM-DD-HH',dirname:'src/logs'});
const infoTransport =  new transports.DailyRotateFile({dirname:'src/logs',filename:'info-%DATE%.log',maxSize: '10m',
maxFiles: '7d', datePattern: 'YYYY-MM-DD-HH'})

const combinedTransport = new transports.DailyRotateFile({dirname:'src/logs',filename:'combined-%DATE%.log',maxSize: '10m',
maxFiles: '7d', datePattern: 'YYYY-MM-DD-HH'});
